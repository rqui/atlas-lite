...
- `src/atlas_dto.rs`: narrow response DTOs for note summary pages/documents, search, View
  ...
  pre-deserialization response-size guard.
...
- FOCUSED: `cargo +stable test --target aarch64-apple-darwin --test atlas_dto` — 6/6 passed.
- HOST: `./scripts/validate.sh` — 338 unit tests plus 17 integration tests passed; source and
